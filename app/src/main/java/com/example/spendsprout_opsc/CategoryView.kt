...
/**
 * CategoryView: A custom view that encapsulates the category_layout.xml.
...
class CategoryView @JvmOverloads constructor(
    ...
    // UI elements from category_layout.xml (like public fields in a Unity script)
    ...
    init {
        ...
        LayoutInflater.from(context).inflate(R.layout.category_layout, this, true)
